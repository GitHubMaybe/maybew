	...
	<script type="text/javascript">
	      ...
	      $(function(){
			...
			function showMyGrapList() {
					...
					$.ajax({
						type:"post",
						url:"meetingpub/findGrapBypid",
						data:{"pid":pid},
						success:function(msg){
							var appendHtml = "<font style='padding: 10px 10px 10px 15px;display: block;color: #777777;'>共有"+msg.length+"人抢此会议</font>";
				        	var uname="";
				        	var province="";
				        	var gremark="";
				        	var uid="";
			...
			function chooseGrap(pid,uid){
				...
				if(confirm("确定要选择该用户为抢单者吗？")){
					$.ajax({
						type:"post",
						url:"meetinggrap/updateGrapChoose",
